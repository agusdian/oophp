...
class produk #ini adalah class
{
    ...
    public function __construct($judul, $penulis, $pengarang, $harga, $jmlHalaman, $waktuMain) #penulisan constructor
    {
        $this->judul = $judul;
...
class Komik extends Produk
{
    public function getInfoProduk()
    {
        $str = "Komik : {$this->judul} | {$this->getlebel()} {$this->harga} - {$this->jmlHalaman} halaman.";
        return $str;
    }
}
class Game extends Produk
{
    public function getInfoProduk()
    {
        $str = "Game : {$this->judul} | {$this->getlebel()} {$this->harga} ~ {$this->waktuMain} Jam.";
        return $str;
    }
}
...
$produk1 = new Komik("Naruto", "Masasikisimoto", "Sonenjump", "Rp. 30000", 100, 0); #setelah menggunakan constructor
$produk2 = new Game("PUBG", "DANIEL LOG", "Barbare", "Rp. 80000", 0, 150);
